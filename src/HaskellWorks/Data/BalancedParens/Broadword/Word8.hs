...
findCloseFar p x =
  ...
  let pc2   = ((ck2 .>. fromIntegral sak2) .|. ek2) .&. mk2                               in
  let po2   =  (ok2 .>. fromIntegral sak2)          .&. mk2                               in
  let pbk2  = pak2 - pc2                                                                  in
  let pck2  = pbk2 + po2                                                                  in
  let sb2   = sak2 + (t8k2 .&. bk2)                                                       in
