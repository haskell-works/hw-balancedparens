...
--
-- >>> findCloseFar 0 $ fromJust $ bitRead "10000000 00000000"
-- 2
--
...
--
-- >>> findCloseFar 0 $ fromJust $ bitRead "11111111 00000000"
-- 16
--
-- The following scans for the first unmatched closing parenthesis from the beginning of the bit string, but runs
...
--
-- >>> findCloseFar 0 $ fromJust $ bitRead "11111111 11111111"
-- 32
--
-- Following are some more examples:
--
-- >>> findCloseFar 0 $ fromJust $ bitRead "11110000 11110000"
-- 16
-- >>> findCloseFar 1 $ fromJust $ bitRead "11110000 11110000"
-- 7
-- >>> findCloseFar 2 $ fromJust $ bitRead "11110000 11110000"
-- 6
-- >>> findCloseFar 3 $ fromJust $ bitRead "11110000 11110000"
-- 5
-- >>> findCloseFar 4 $ fromJust $ bitRead "11110000 11110000"
-- 4
-- >>> findCloseFar 5 $ fromJust $ bitRead "11110000 11110000"
-- 5
-- >>> findCloseFar 6 $ fromJust $ bitRead "11110000 11110000"
-- 6
-- >>> findCloseFar 7 $ fromJust $ bitRead "11110000 11110000"
-- 7
-- >>> findCloseFar 8 $ fromJust $ bitRead "11110000 11110000"
-- 16
